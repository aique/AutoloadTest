<?php
	...
	class Library_I18n_I18n
	{
		...
		{
			return Library_I18n_Text_TextClient::getFileContent($name, $filePath, $view);
		}
		 ...
		 */
		public static function getDate($date, $format = Library_I18n_Date_DateFormat::SHORT)
		{
			return Library_I18n_Date_DateClient::getDate($date, $format);
		}
		...
		{
			return Library_I18n_Date_DateClient::getMonthName($monthNumber);
		}
		 ...
		 */
		public static function getMoney($money, $format = Library_I18n_Money_MoneyFormat::CURRENCY)
		{	
			return Library_I18n_Money_MoneyClient::getMoney($money, $format);
		}
