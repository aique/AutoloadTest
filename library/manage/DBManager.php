 ...
 * 
 */
class Library_Manage_DBManager extends mysqli
{
	private $server;
	private $dbName;
	private $user;
	...
	{
		$this->server = Library_Manage_ResourceManager::getConfig()->getVar('db.hostname');
		$this->dbName = Library_Manage_ResourceManager::getConfig()->getVar('db.database');
		$this->user = Library_Manage_ResourceManager::getConfig()->getVar('db.username');
 		$this->pass = Library_Manage_ResourceManager::getConfig()->getVar('db.password');
	 ...
	 *
	 * @return Library_Manage_DBManager
	 * 
	 */
	...
	{
		Library_Manage_ResourceManager::getLogger()->logDBConnection($this);
