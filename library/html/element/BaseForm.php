...
abstract class Library_Html_Element_BaseForm extends Library_Html_Element_FormElement
{
	protected $elements;
	protected $actions;
	protected $legend;
								...
								$template = null)
	{
		...
		parent::__construct(Library_Html_Const_FormElementConst::FORM, $attributes, $validations, $template, new Library_Html_Printer_FormPrinter());

		$this->printer->setElement($this);
		
		$this->printer->setTemplate(Library_Html_Printer_PrinterClient::getDefaultTemplate($this));
		
		$this->validator = new Library_Html_Validation_FormElementValidator($this);
	...
	public function addElement(Library_Html_Element_FormElement $element)
	{
	...
	public function addAction(Library_Html_Element_Input $action)
	{
		$this->actions[] = $action;
	}
