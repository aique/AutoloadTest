...
class Library_Html_Element_RadioGroup extends Library_Html_Element_FormElement
{
	private $radios;
							   ...
							   $template = null)
	{
		...
		parent::__construct(Library_Html_Const_FormElementConst::RADIO_GROUP, $attributes, $validations, $template, new Library_Html_Printer_RadioGroupPrinter());
	}
	...
	public function addRadio(Library_Html_Element_Radio $radio)
	{
		$this->radios[] = $radio;
	}
